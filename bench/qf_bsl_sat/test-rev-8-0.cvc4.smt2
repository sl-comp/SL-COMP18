...
(assert (not (and (sep (pto u (node c0 nx3)) true) (and (sep (pto u (node dt1 nx1)) (wand (pto u (node dt1 v)) (sep (pto nx2 (node c0 a2)) (pto a2 (node c0 a3)) (pto a3 (node c0 a4)) (pto a4 (node c0 a5)) (pto a5 (node c0 a6)) (pto a6 (node c0 a7)) (pto a7 (node c0 (as nil Loc))) (pto u (node c0 (as nil Loc)))))) (sep (pto u (node dt2 nx2)) true)))))
