...
(define-fun neg7 ((z Loc) (c Loc) (j Int)) Bool (or (and (pto z c) (= j 0)) (sep (not (pto z c)) (or (and (pto t d) (= (- j 1) 0)) (sep (not (pto t d)) (or (and (pto t0 d0) (= (- (- j 1) 1) 0)) (sep (not (pto t0 d0)) (or (and (pto t00 d00) (= (- (- (- j 1) 1) 1) 0)) (sep (not (pto t00 d00)) (or (and (pto t000 d000) (= (- (- (- (- j 1) 1) 1) 1) 0)) (sep (not (pto t000 d000)) (or (and (pto t0000 d0000) (= (- (- (- (- (- j 1) 1) 1) 1) 1) 0)) (sep (not (pto t0000 d0000)) (or (and (pto t00000 d00000) (= (- (- (- (- (- (- j 1) 1) 1) 1) 1) 1) 0)) (sep (not (pto t00000 d00000)) (or (and (pto t000000 d000000) (= (- (- (- (- (- (- (- j 1) 1) 1) 1) 1) 1) 1) 0)) (sep (not (pto t000000 d000000)) (and (pto t0000000 d0000000) (= (- (- (- (- (- (- (- (- j 1) 1) 1) 1) 1) 1) 1) 1) 0)))))))))))))))))))
...
(assert (= t00 y0000000))
(assert (= d00 b0000000))
(assert (= t000 y0000000))
(assert (= d000 b0000000))
(assert (= t0000 y0000000))
(assert (= d0000 b0000000))
(assert (= t00000 y0000000))
(assert (= d00000 b0000000))
(assert (= t000000 y0000000))
(assert (= d000000 b0000000))
(assert (= t0000000 y0000000))
(assert (= d0000000 b0000000))
;-----------------
