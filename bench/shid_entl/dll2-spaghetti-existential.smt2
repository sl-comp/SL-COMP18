...
(assert (not (exists (
                     (hd1 RefDLL2_t) (tl1 RefDLL2_t)
                     (hd2 RefDLL2_t) (tl2 RefDLL2_t)
                     (hd3 RefDLL2_t) (tl3 RefDLL2_t)
                     (hd4 RefDLL2_t) (tl4 RefDLL2_t)
                     (hd5 RefDLL2_t) (tl5 RefDLL2_t)
                     (hd6 RefDLL2_t) (tl6 RefDLL2_t)
                     (hd7 RefDLL2_t) (tl7 RefDLL2_t)
                     (hd8 RefDLL2_t) (tl8 RefDLL2_t)
                     (hd9 RefDLL2_t) (tl9 RefDLL2_t)
                     (hd10 RefDLL2_t) (tl10 RefDLL2_t)
                     (hd11 RefDLL2_t) (tl11 RefDLL2_t)
                     (hd12 RefDLL2_t) (tl12 RefDLL2_t)
                     (hd13 RefDLL2_t) (tl13 RefDLL2_t)
                     (hd14 RefDLL2_t) (tl14 RefDLL2_t)
                     (hd15 RefDLL2_t) (tl15 RefDLL2_t)
                     (hd16 RefDLL2_t) (tl16 RefDLL2_t)
                     (hd17 RefDLL2_t) (tl17 RefDLL2_t)
                     (hd18 RefDLL2_t) (tl18 RefDLL2_t)
                     (hd19 RefDLL2_t) (tl19 RefDLL2_t)
                     )
		(sep 
