...
** Participation
   ...
   - 2018: /=qf_shid_entl=/, /=qf_shid_sat=/, /=qf_shls_entl=/, /=qf_shls_sat=/, /=qf_shlid_entl=/, /=shid_entl=/
...
** Description
#+BEGIN_QUOTE
The SL procedure of the famous CVC4 solver.
#+END_QUOTE
...
** Participation
   - 2014: pull out from /=qf_shls_entl=/, /=qf_shls_sat=/
...
** Participation
   - 2018: pull out from /=qf_shls_sat=/, /=qf_shls_entl=/, /=qf_bsl_sat=/, /=bsl_sat=/
